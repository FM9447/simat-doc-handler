                  ...
                  children: [
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        ...
                        mainAxisSize: pw.MainAxisSize.min,
                        children: [
                          pw.Text('Ref No: ${document.id.length >= 6 ? document.id.substring(document.id.length - 6).toUpperCase() : document.id}', style: const pw.TextStyle(fontSize: 7, color: PdfColors.grey600)),
                          pw.SizedBox(height: 2),
